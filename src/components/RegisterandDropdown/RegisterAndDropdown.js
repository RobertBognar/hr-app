...
const RegisterAndDropdown = () => {
    ...
    async function GetCompanies() {
        let companies = await GetCompaniesService.getCompanies();
        if (companies) setCompanySelection(companies);
    }
    useEffect(() => {
        GetCompanies();
    }, []);
...
export default RegisterAndDropdown;
